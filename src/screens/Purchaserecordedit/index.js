...
import {ScrollView,Text,View,TouchableOpacity,StyleSheet,SafeAreaView,TextInput,Pressable} from 'react-native';
...
const Purchaserecordedit = ({navigation}) => {
                        ...
                        <View style={styles.contentContainer}>
                            ...
                            <View>
                                ...
                                <Picker
                                    ...
                                    <Picker.Item
                                    label={`${supplier.supplier.toString()}`}
                    ...
                    <ScrollView horizontal>
                        <View>
                            <View style={styles.footer}>
                                ...
                                <Text style={{color:"#1D2022",fontSize:12,fontWeight:"700",marginVertical:10,marginRight:40}}>Records No</Text>
                                <Text style={{color:"#1D2022",fontSize:12,fontWeight:"700",marginVertical:10,marginRight:20}}>Supplier</Text>
                                <Text style={{color:"#1D2022",fontSize:12,fontWeight:"700",marginVertical:10,marginRight:20}}>Orders</Text>
                                <Text style={{color:"#1D2022",fontSize:12,fontWeight:"700",marginVertical:10,marginRight:20}}>Received</Text>
                                <Text style={{color:"#1D2022",fontSize:12,fontWeight:"700",marginVertical:10,marginRight:20}}>Name</Text>
                                <Text style={{color:"#1D2022",fontSize:12,fontWeight:"700",marginVertical:10,marginRight:20}}>Name</Text>
                                <Text style={{color:"#1D2022",fontSize:12,fontWeight:"700",marginVertical:10,marginRight:20}}>Name</Text>
                            </View>
                            <View style={styles.recordContainer}>
                                <View style={styles.recordBack}>
                                        ...
                                        <View>
                                            <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:40}}>Company1</Text>
                                        </View>
                                        <View>
                                            <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:50}}>45</Text>
                                        </View>
                                        <View>
                                        <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:50}}>R2</Text>
                                        </View>
                                        <View>
                                        <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:50}}>12</Text>
                                        </View>
                                        <View>
                                        <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:50}}>12</Text>
                                        </View>
...
export default Purchaserecordedit;

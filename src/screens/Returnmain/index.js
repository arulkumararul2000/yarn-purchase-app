                            ...
                            <View>
                                ...
                                <View>
                                    ...
                                    <SelectDropdown
                                        ...
                                        defaultButtonText={'Select Return No'}
                                        buttonTextAfterSelection={(selectedItem, index) => {
                                        return selectedItem;
                                        }}
                                        rowTextForSelection={(item, index) => {
                                ...
                                <View style={styles.buttonContainer}>
                                    <TouchableOpacity style={styles.clearButton}>
                                        <Text style={[styles.text,{color:"#ffff",fontWeight:"600",fontSize:16}]}>Save</Text>
                                    </TouchableOpacity>
                    ...
                    <ScrollView horizontal>
                        <View>
                            <View style={styles.footer}>
                                ...
                                <Text style={{color:"#1D2022",fontSize:12,fontWeight:"700",marginVertical:10,marginRight:20}}>WorkOrder No</Text>
                                <Text style={{color:"#1D2022",fontSize:12,fontWeight:"700",marginVertical:10,marginRight:20}}>Order No</Text>
                                <Text style={{color:"#1D2022",fontSize:12,fontWeight:"700",marginVertical:10,marginRight:20}}>Returns No</Text>
                            ...
                            <View style={styles.recordContainer}>
                                <View style={styles.recordBack}>
                                    ...
                                    <View style={styles.recordBack}>
                                        ...
                                        <View>
                                            <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:40}}>4455662</Text>
                                        </View>
                                        <View>
                                            <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:50}}>2233442</Text>
                                        </View>
                                        <View>
                                    ...
                                    <View style={styles.recordBack}>
                                        ...
                                        <View>
                                            <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:40}}>4455663</Text>
                                        </View>
                                        <View>
                                            <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:50}}>2233443</Text>
                                        </View>
                                        <View>
                                        <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:50}}>30</Text>
                                        </View>
                                    </View>
                                    <View style={styles.recordBack}>
                                        <CheckBox
                                        ...
                                        <View>
                                            <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:40}}>4455664</Text>
                                        </View>
                                        <View>
                                            <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:50}}>2233444</Text>
                                        </View>
                                        <View>
                                        <Text style={{color:"#1D2022",fontSize:10,marginVertical:10,marginRight:50}}>20</Text>
                                        </View> 
                                    </View>
                            </View>
                        </View>
